...
class NewsItem:
    ...
    def update_search_tokens(self) -> None:
        ...
        # Include cached translations so both Russian and English queries match.
        translated_title, translated_desc = self.translated(TARGET_LANG)
        tokens.update(tokenize(translated_title))
        tokens.update(tokenize(translated_desc))
...
def index(
    ...
    if query_candidates:
        ...
        for candidate in query_candidates:
            for item in filter_items(items, candidate):
